...
import dhalla.sarfaraz.databasepractice.connectdata.SessionManager;
//import sokohuru.muchbeer.king.sokohuruinsert.database.SQLiteHandler;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String name = itemEt.getText().toString();
                String price = priceEt.getText().toString();

                if (!name.isEmpty() && !price.isEmpty()) {
                    registerUser(name, price);
                } else {
     ...
     * */
    private void registerUser(final String name, final String price) {
